...
class EventFilter(object):
    ...
    def detect(self,folder):
        ...
        if self.m_procedure.detect(self.m_aqui,folder) == 0:
            self.m_state = False
        else:
            indexes_fs_left, indexes_fo_left, indexes_fs_right, indexes_fo_right =  self.m_procedure.detect(self.m_aqui,folder)
            self.m_state = True
